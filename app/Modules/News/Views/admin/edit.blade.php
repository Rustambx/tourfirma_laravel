                        ...
                        <form action="{{ route('admin.news.update', $news->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="title" name="title" value="{{ $news->title }}" placeholder="Text" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="preview_text" id="preview_text" rows="9" placeholder="Текст..." class="form-control html-editor">{{ $news->preview_text }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="detail_text" id="detail_text" rows="9" placeholder="Текст..." class="form-control html-editor">{{ $news->detail_text }}</textarea>
                                </div>
                            </div>
